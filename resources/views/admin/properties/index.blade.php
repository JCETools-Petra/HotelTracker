                                ...
                                @forelse ($properties as $property)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                            ...
                                            <form method="POST" action="{{ route('admin.properties.destroy', $property->id) }}" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus properti ini? Semua data pendapatan terkait juga akan terhapus.');">
                                                @csrf
                                                @method('DELETE')

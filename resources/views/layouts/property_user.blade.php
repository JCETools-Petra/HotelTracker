{{-- resources/views/layouts/property_user.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                @auth
                    {{ Auth::user()->property ? Auth::user()->property->name : 'Property Dashboard' }}
                @else
            ...
            <nav>
                ...
                <x-nav-link :href="route('property.income.index')" :active="request()->routeIs('property.income.index')">

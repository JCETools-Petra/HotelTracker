...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Manajemen Reservasi')); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-4">
                ...
                <form action="<?php echo e(route('property.reservations.index')); ?>" method="GET">
                    <div class="flex items-center">
                        <input type="text" name="search" value="<?php echo e($search ?? ''); ?>" placeholder="Cari nama tamu..." class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <?php $__empty_1 = true; $__currentLoopData = $reservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap font-medium"><?php echo e($reservation->guest_name); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($reservation->checkin_date)->translatedFormat('d F Y')); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($reservation->checkout_date)->translatedFormat('d F Y')); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center"><?php echo e($reservation->number_of_rooms); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="<?php echo e(route('property.reservations.edit', $reservation)); ?>" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-200">Edit</a>
                                            <form action="<?php echo e(route('property.reservations.destroy', $reservation)); ?>" method="POST" class="inline-block ml-4" onsubmit="return confirm('Anda yakin ingin menghapus reservasi ini?');">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /home/apsx2353/public_html/hoteliermarket.my.id/resources/views/property/reservations/index.blade.php ENDPATH**/ ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="<?php echo e(route('property.occupancy.update')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="flex flex-wrap items-end gap-4">
                            <div>
                                ...
                                <input type="number" name="occupied_rooms" value="<?php echo e($occupancyToday->occupied_rooms); ?>" class="mt-1 block rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">Rp <?php echo e(number_format($property->dailyIncomes()->sum('total_revenue'), 0, ',', '.')); ?></p>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300">Pendapatan Kamar</h3>
                    <p class="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">Rp <?php echo e(number_format($property->dailyIncomes()->sum('total_rooms_revenue'), 0, ',', '.')); ?></p>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300">Pendapatan F&B</h3>
                    <p class="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">Rp <?php echo e(number_format($property->dailyIncomes()->sum('total_fb_revenue'), 0, ',', '.')); ?></p>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300">Lain-lain</h3>
                    <p class="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">Rp <?php echo e(number_format($property->dailyIncomes()->sum('others_income'), 0, ',', '.')); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $property->dailyIncomes()->latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo e(Carbon\Carbon::parse($income->date)->isoFormat('dddd, D MMMM YYYY')); ?></td>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\HotelTracker\resources\views/property/dashboard.blade.php ENDPATH**/ ?>
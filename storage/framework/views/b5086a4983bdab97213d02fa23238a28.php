...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'start_date_filter','class' => 'block mt-1 w-full','type' => 'date','name' => 'start_date','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($filterStartDate ? $filterStartDate->toDateString() : '')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'end_date_filter','class' => 'block mt-1 w-full','type' => 'date','name' => 'end_date','value' => $filterEndDate ? $filterEndDate->toDateString() : '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'end_date_filter','class' => 'block mt-1 w-full','type' => 'date','name' => 'end_date','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($filterEndDate ? $filterEndDate->toDateString() : '')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Ringkasan Kinerja Keseluruhan</h3>
                 <p class="text-xs text-gray-500 dark:text-gray-400 mb-4">
                    ...
                    (Total <?php echo e($filterEndDate->diffInDays($filterStartDate) + 1); ?> hari)
                </p>
                 <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
                        <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Pendapatan</h4>
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">Rp <?php echo e(number_format($totalOverallRevenue, 0, ',', '.')); ?></p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
                        <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Rata-Rata Pendapatan Harian</h4>
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">Rp <?php echo e(number_format($averageDailyOverallRevenue, 0, ',', '.')); ?></p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
                        <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Jml. Properti Aktif</h4>
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($activePropertiesCount); ?></p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
                        <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Jml. Pengguna Properti</h4>
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($activePropertyUsersCount); ?></p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
                        <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Rata-Rata Pendapatan/Properti</h4>
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">Rp <?php echo e(number_format($averageRevenuePerProperty, 0, ',', '.')); ?></p>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mb-4">
                 ...
                 <div class="grid grid-cols-1 <?php if(!empty($multiMonthCategoryGrowth) && count($multiMonthCategoryGrowth) > 0): ?> md:grid-cols-2 <?php else: ?> md:grid-cols-1 <?php endif; ?> gap-6 mb-6">
                    <div class="p-4 border dark:border-gray-700 rounded-lg <?php if(empty($multiMonthCategoryGrowth) || count($multiMonthCategoryGrowth) == 0): ?> md:col-span-1 <?php else: ?> md:col-span-1 <?php endif; ?>">
                    ...
                    <?php if(!empty($multiMonthCategoryGrowth) && count($multiMonthCategoryGrowth) > 0): ?>
                    <div class="p-4 border dark:border-gray-700 rounded-lg space-y-2">
                        ...
                        <?php $__currentLoopData = $multiMonthCategoryGrowth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monthName => $growths): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="mb-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-md shadow-sm">
                                ...
                                <?php if(empty($growths)): ?>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 italic">Tidak ada data pertumbuhan untuk bulan ini.</p>
                                <?php else: ?>
                                    <ul class="space-y-1 text-sm">
                                    <?php $__currentLoopData = $growths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $growthData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="flex justify-between">
                                            <span class="font-medium text-gray-800 dark:text-gray-300"><?php echo e($growthData['category']); ?>:</span>
                                            <span class="<?php echo e(Str::contains($growthData['growth'], '+') || $growthData['growth'] === 'Baru' ? 'text-green-600 dark:text-green-400 font-semibold' : (Str::contains($growthData['growth'], '-') ? 'text-red-600 dark:text-red-400 font-semibold' : 'text-gray-600 dark:text-gray-400')); ?>">
                                                <?php echo e($growthData['growth']); ?>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mb-4">
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($targetAnalysis['properties_achieved_count']); ?></p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
                        <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">% Properti Mencapai Target</h4>
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($targetAnalysis['properties_achieved_percentage']); ?></p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
                        <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Rata-rata Pencapaian Target</h4>
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($targetAnalysis['average_achievement_percentage']); ?></p>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const trendKontribusiKategoriData = <?php echo json_encode($trendKontribusiData, 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\property_finance\resources\views/admin/kpi_analysis.blade.php ENDPATH**/ ?>
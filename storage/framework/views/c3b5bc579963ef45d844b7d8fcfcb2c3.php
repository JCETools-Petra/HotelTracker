        ...
        <div class="email-container">
            ...
            <div class="email-body">
                ...
                <p>
                    ...
                    <strong><?php echo e($property->name); ?></strong> pada tanggal
                    <strong><?php echo e(\Carbon\Carbon::parse($occupancy->date)->translatedFormat('l, d F Y')); ?></strong>.
                </p>
                
                <table class="details-table">
                    <tr>
                        <th>Total Kamar Terisi</th>
                        <td><strong><?php echo e($occupancy->occupied_rooms); ?></strong></td>
                    </tr>
                    <tr>
                        <th>Dari Reservasi OTA</th>
                        <td><?php echo e($occupancy->reservasi_ota); ?></td>
                    </tr>
                    <tr>
                        <th>Dari Input Properti (Manual)</th>
                        <td><?php echo e($occupancy->reservasi_properti); ?></td>
                    </tr>
                </table>
                ...
                <a href="<?php echo e(route('ecommerce.dashboard', ['property_id' => $property->id])); ?>" class="cta-button">
                    Lihat Dasbor
                </a>
            </div>
...
</html><?php /**PATH /home/apsx2353/public_html/hoteliermarket.my.id/resources/views/emails/occupancy_update.blade.php ENDPATH**/ ?>